...
public class ARIAActions : MonoBehaviour
{
    ...
    [Header("Investigator + Estado Emocional")]
    ...
    public void OnMessageReceived()
    {
        ...
        // Trust escala com o estado emocional da ARIA
        float multiplier = emotionalState != null ? emotionalState.TrustMultiplier : 1f;
        ...
        Debug.Log($"ARIA Trust: {trustLevel}/{trustThreshold} (x{multiplier} — {emotionalState?.CurrentState})");
    ...
    {
        // zone pode ser null/vazio → ARIAInvestigator escolhe random
        string zone = args?["zone"]?.ToString();
